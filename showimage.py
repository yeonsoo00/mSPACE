...
thresh = 255-cv2.adaptiveThreshold(low_img, 255,cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, 21, 0)
cv2.imwrite("./09012023-output/DAPI_identified_threshold.tif",thresh)
...
cv2.imwrite("./09012023-output/DAPI_nuecial_identified.tif",try_data)
